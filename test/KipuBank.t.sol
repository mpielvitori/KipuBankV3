...
contract KipuBankTest is Test {
    ...
    function testNoDirectPairRejection() public {
        ...
        vm.mockCall(NON_EXISTENT_PAIR_TOKEN, abi.encodeWithSignature("transferFrom(address,address,uint256)"), abi.encode(true));
    ...
    function testWithdrawExceedsLimit() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(KipuBank.ExceedsWithdrawLimitUSD.selector, excessiveAmount, WITHDRAWAL_LIMIT));
    ...
    function testWithdrawalLimitEnforcement() public {
        if (usdcAddress != address(0)) {
            ...
            vm.expectRevert(abi.encodeWithSelector(KipuBank.ExceedsWithdrawLimitUSD.selector, largeWithdrawal, WITHDRAWAL_LIMIT));
